...
namespace Vendor.UI.Migrations
{
    ...
    [Migration("20221104120500_SeedCompany")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Vendor.Data.Models.Authorized_Contacts", b =>
                {
                    ...
                    b.Property<int?>("Authorized_ContactsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("Authorized_ContactsId");
            ...
            modelBuilder.Entity("Vendor.Data.Models.Notifications", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Created_By = "Bill",
                            Date_Sent = new DateTime(2022, 11, 4, 8, 4, 57, 897, DateTimeKind.Local).AddTicks(5666),
                        ...
                        new
                        {
                            ...
                            Created_By = "Bill",
                            Date_Sent = new DateTime(2022, 11, 4, 8, 4, 57, 897, DateTimeKind.Local).AddTicks(5720),
                            Days_Reoccuring = 7,
            ...
            modelBuilder.Entity("Vendor.Data.Models.Authorized_Contacts", b =>
                {
                    b.HasOne("Vendor.Data.Models.Authorized_Contacts", null)
                        .WithMany("Contact")
                        .HasForeignKey("Authorized_ContactsId");
